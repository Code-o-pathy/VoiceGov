    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-[#0b3d67] to-[#0b5cab] text-white">
        <div className="mx-auto max-w-6xl px-6 py-10">
          <div className="mb-3 inline-block rounded-full bg-yellow-400 px-3 py-1 text-xs font-bold uppercase text-[#0b3d67]">
            Hackathon Prototype
          </div>
          ...
          <p className="mt-3 max-w-xl text-sm text-white/80">
            Access a wide range of taxpayer services through a voice-first interface.
          </p>
          <button
      ...
      <section className="border-t border-slate-200 bg-white">
        <div className="mx-auto grid max-w-6xl gap-4 px-6 py-8 sm:grid-cols-3">
          {[
            ...
            {
              t: "Taxpayer Services",
              d: "24x7 voice-enabled access for e-Filing related services.",
            },
            {
              t: "Refund Status",
